...
namespace KAF.BusinessDataObjects
{
    ...
    public partial class cor_foldercontentsEntity : BaseEntity
    {
        ...
        //Only For Gate Management to segregate upload file type like contact doc, excel file , civil id doc etc.
        private long? _requestfiletypeid;

        [DataMember]
        public long? requestfiletypeid { get => _requestfiletypeid; set => _requestfiletypeid = value; }
     [DataMember]
