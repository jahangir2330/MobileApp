...
{
    public partial class tran_applicationreqforempnotesEntity
    {
        ...
        public tran_applicationreqforempnotesEntity(IDataReader reader, bool IsListViewShow, bool relationalData)
        {
    ...
    public class dtapplicationnote : DtParameters
    {
