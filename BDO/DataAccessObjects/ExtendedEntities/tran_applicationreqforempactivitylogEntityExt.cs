...
{
    public partial class tran_applicationreqforempactivitylogEntity
    {
        ...
        public tran_applicationreqforempactivitylogEntity(IDataReader reader, bool IsListViewShow, bool relationalData)
        {
    ...
    public class dtapplicationactivitylog : DtParameters
    {
