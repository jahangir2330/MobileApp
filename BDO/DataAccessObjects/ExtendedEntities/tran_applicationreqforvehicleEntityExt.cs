...
{
    public partial class tran_applicationreqforvehicleEntity
    {
        #region Properties
        ...
        public tran_applicationreqforvehicleEntity(IDataReader reader, bool IsListViewShow, bool withRelationalData)
        {
    ...
    public partial class DTtran_applicationreqforvehicleEntity : DtParameters
    {
    ...
    [Serializable]
    [DataContract(Name = "summaryamountofvehiclerequest", Namespace = "http://www.KAF.com/types")]
    public partial class summaryamountofvehiclerequest : BaseEntity
    {
        ...
        [DataMember]
        public long? requestvehicleid { get => _requestvehicleid; set => _requestvehicleid = value; }
        [DataMember]
        ...
        #region Constructor
        public summaryamountofvehiclerequest() : base()
        {
        }

        public summaryamountofvehiclerequest(IDataReader reader)
        {
