...
{
    public partial class tran_applicationreqforvehiclenotesEntity
    {
        ...
        public tran_applicationreqforvehiclenotesEntity(IDataReader reader, bool IsListViewShow, bool relationalData)
        {
    ...
    public class dtvehiclenote : DtParameters
    {
